...
frontend("IR Codegen Docs", { pwa: { enabled: true, name: "IR Codegen Docs", shortName: "IRDocs", startUrl: "/", scope: "/" } }, (app) => {
    ...
    app.component("FeedbackForm", (c) => {
        c.field("name", "string", "Name", { required: true }, { icon: "User" });
        c.field("email", "string", "Email", { required: true }, { icon: "Mail" });
        c.field("message", "string", "Message", { required: true }, { icon: "MessageSquare", placeholder: "Share your thoughts" });
    });
});
