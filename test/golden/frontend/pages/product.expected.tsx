  ...
  return (
    <div className="space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <header className="border-b border-slate-200 dark:border-slate-800 pb-10">
        ...
        <h1 className="text-5xl md:text-6xl font-black text-slate-950 dark:text-white tracking-tighter">Product</h1>
        <p className="mt-4 text-slate-500 dark:text-slate-400 text-lg max-w-3xl leading-relaxed font-medium">Manage your product assets and application state in this unified view.</p>
      </header>
